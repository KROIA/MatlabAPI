...
// ---------------------------------------------------------------------------
#ifdef NDEBUG
	#define MATLAB_API_CONSOLE(msg)
	#define MATLAB_API_CONSOLE_FUNCTION(msg)
#else
	#include <iostream>

	#define MATLAB_API_DEBUG
	#define MATLAB_API_CONSOLE_STREAM std::cout

	// Print msg to stdout.
	#define MATLAB_API_CONSOLE(msg) MATLAB_API_CONSOLE_STREAM << msg;
	// Print the current function signature followed by msg to stdout.
	#define MATLAB_API_CONSOLE_FUNCTION(msg) MATLAB_API_CONSOLE_STREAM << __PRETTY_FUNCTION__ << " " << msg;
#endif
...
// ---------------------------------------------------------------------------
	...
	#define MATLAB_API_PROFILING_BLOCK_C(text, color) EASY_BLOCK(text, color)
	// Non-scoped profiling block — must be closed with PROFILING_END_BLOCK.
	#define MATLAB_API_PROFILING_NONSCOPED_BLOCK_C(text, color) EASY_NONSCOPED_BLOCK(text, color)
	// End a non-scoped profiling block.
	#define MATLAB_API_PROFILING_END_BLOCK EASY_END_BLOCK
	// Profile the enclosing function with an explicit color value.
	#define MATLAB_API_PROFILING_FUNCTION_C(color) EASY_FUNCTION(color)
	// Scoped profiling block using a color stage name (e.g. Cyan500).
	#define MATLAB_API_PROFILING_BLOCK(text, colorStage) MATLAB_API_PROFILING_BLOCK_C(text,profiler::colors::  colorStage)
	// Non-scoped profiling block using a color stage name.
	#define MATLAB_API_PROFILING_NONSCOPED_BLOCK(text, colorStage) MATLAB_API_PROFILING_NONSCOPED_BLOCK_C(text,profiler::colors::  colorStage)
	// Profile the enclosing function using a color stage name.
	#define MATLAB_API_PROFILING_FUNCTION(colorStage) MATLAB_API_PROFILING_FUNCTION_C(profiler::colors:: colorStage)
	// Assign a name to the current thread in the profiler output.
	#define MATLAB_API_PROFILING_THREAD(name) EASY_THREAD(name)

	// Capture a named scalar value in the profiler timeline.
	#define MATLAB_API_PROFILING_VALUE(name, value) EASY_VALUE(name, value)
	// Capture a named text string in the profiler timeline.
	#define MATLAB_API_PROFILING_TEXT(name, value) EASY_TEXT(name, value)

#else
	#define MATLAB_API_PROFILING_BLOCK_C(text, color)
	#define MATLAB_API_PROFILING_NONSCOPED_BLOCK_C(text, color)
	#define MATLAB_API_PROFILING_END_BLOCK
	#define MATLAB_API_PROFILING_FUNCTION_C(color)
	#define MATLAB_API_PROFILING_BLOCK(text, colorStage)
	#define MATLAB_API_PROFILING_NONSCOPED_BLOCK(text, colorStage)
	#define MATLAB_API_PROFILING_FUNCTION(colorStage)
	#define MATLAB_API_PROFILING_THREAD(name)

	#define MATLAB_API_PROFILING_VALUE(name, value)
	#define MATLAB_API_PROFILING_TEXT(name, value)
#endif
...
// ---------------------------------------------------------------------------
#define MATLAB_API_COLOR_STAGE_1 50
#define MATLAB_API_COLOR_STAGE_2 100
#define MATLAB_API_COLOR_STAGE_3 200
#define MATLAB_API_COLOR_STAGE_4 300
#define MATLAB_API_COLOR_STAGE_5 400
#define MATLAB_API_COLOR_STAGE_6 500
#define MATLAB_API_COLOR_STAGE_7 600
#define MATLAB_API_COLOR_STAGE_8 700
#define MATLAB_API_COLOR_STAGE_9 800
#define MATLAB_API_COLOR_STAGE_10 900
#define MATLAB_API_COLOR_STAGE_11 A100
#define MATLAB_API_COLOR_STAGE_12 A200
#define MATLAB_API_COLOR_STAGE_13 A400
#define MATLAB_API_COLOR_STAGE_14 A700
...
// ---------------------------------------------------------------------------
#define MATLAB_API_GENERAL_PROFILING_COLORBASE Cyan
#define MATLAB_API_GENERAL_PROFILING_BLOCK_C(text, color) MATLAB_API_PROFILING_BLOCK_C(text, color)
#define MATLAB_API_GENERAL_PROFILING_NONSCOPED_BLOCK_C(text, color) MATLAB_API_PROFILING_NONSCOPED_BLOCK_C(text, color)
#define MATLAB_API_GENERAL_PROFILING_END_BLOCK MATLAB_API_PROFILING_END_BLOCK;
#define MATLAB_API_GENERAL_PROFILING_FUNCTION_C(color) MATLAB_API_PROFILING_FUNCTION_C(color)
#define MATLAB_API_GENERAL_PROFILING_BLOCK(text, colorStage) MATLAB_API_PROFILING_BLOCK(text, CONCAT_SYMBOLS(MATLAB_API_GENERAL_PROFILING_COLORBASE, colorStage))
#define MATLAB_API_GENERAL_PROFILING_NONSCOPED_BLOCK(text, colorStage) MATLAB_API_PROFILING_NONSCOPED_BLOCK(text, CONCAT_SYMBOLS(MATLAB_API_GENERAL_PROFILING_COLORBASE, colorStage))
#define MATLAB_API_GENERAL_PROFILING_FUNCTION(colorStage) MATLAB_API_PROFILING_FUNCTION(CONCAT_SYMBOLS(MATLAB_API_GENERAL_PROFILING_COLORBASE, colorStage))
#define MATLAB_API_GENERAL_PROFILING_VALUE(name, value) MATLAB_API_PROFILING_VALUE(name, value)
#define MATLAB_API_GENERAL_PROFILING_TEXT(name, value) MATLAB_API_PROFILING_TEXT(name, value)
